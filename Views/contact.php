        ...
        <div class="container-fruid" >
            ...
            <div class="contact">
                ...
                <form action="confirm.php" method="post">
                    ...
                    <div>
                    <label>フリガナ：<input type="text" name="kana" placeholder="例）ヤマダタロウ">
                    </div>
                    <div>
                    <label>電話番号：<input type="text" name="tel" placeholder="例）00012345678">
                    </div>
                    <div>
                    <label>メールアドレス：<input type="text" name="email" placeholder="例）xxx@xxx">
                    </div>
                    <div>
                    <h5>お問合せ内容<h5>
